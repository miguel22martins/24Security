...
public class UtilizadorController {
    ...
    @GetMapping(path = "/{id}/planos", produces= MediaType.APPLICATION_JSON_VALUE)
    public Iterable<ListaUtilizador> getPlanosAssociados(@PathVariable int id)
    {
        logger.info("Consulta utilizadores associados a um plano " + id);
        return utilizadorRepository.findPlanosAssociados(id);
    }
}
